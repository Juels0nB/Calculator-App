    ...
    <div className="space-y-6 p-8 bg-white/80 rounded-2x1 shadow-2x1 rounded-xl border border-slate-200">
      ...
      <div className="grid grid-cols-4 gap-4 font-mono text-xl">
        <button
          ...
          className="p-5 bg-slate-400/80 rounded-md border shadow animate-fade-in  hover:scale-105"
        >
        ...
        <button
          onClick={() => handleButtonClick("÷")}
          className="p-5 bg-orange-400/80 rounded-md border shadow animate-fade-in hover:scale-105"
        >
          ÷
        </button>
        ...
        <button
          ...
          className="p-5 bg-slate-400/80 rounded-md border shadow animate-fade-in col-span-2 hover:scale-105"
        >
          0
        </button>
        <button
